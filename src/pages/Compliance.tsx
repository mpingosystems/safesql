...
export function CompliancePage() {
  return (
    <div style={{ background: '#09090b', color: '#e4e4e7', minHeight: '100vh', padding: 32 }}>
      <a href="#/" style={{ color: '#a78bfa', textDecoration: 'none', fontSize: 13 }}>← SafeSQL</a>
      <div style={{ maxWidth: 760, margin: '24px auto 0' }}>
        <h1 style={{ fontSize: 26 }}>How SafeSQL supports SOC 2 Type 1</h1>
        <p style={{ color: '#a1a1aa', lineHeight: 1.6 }}>
          SafeSQL is designed so that an auditor's SQL-validation questions have a documented answer.
...
const SECTIONS = [
  ...
  { title: 'Confidentiality', body: 'Schema DDL is not stored — only a SHA-256 hash of the validated SQL is kept for the audit trail. No production data passes through SafeSQL.' },
  { title: 'Processing Integrity', body: 'Detection is deterministic AST rules — 33 detectors that either fire or do not. No AI makes a detection decision, so there are no hallucinated findings.' },
